<x-layout>
    ...
    <div class="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- SIDEBAR -->
        <aside class="lg:col-span-1 bg-gray-800/30 rounded-lg border border-gray-700 p-4 h-[75vh] overflow-y-auto">
        ...
        <!-- CHAT PANEL -->
        <div class="lg:col-span-2 bg-gray-800/30 rounded-lg border border-gray-700 flex flex-col h-[75vh] overflow-hidden">
            ...
            <header class="px-6 py-4 flex items-center justify-between border-b border-gray-700">
                ...
                <a href="/people" class="inline-flex items-center px-4 py-2 bg-neon-accent text-black rounded-lg hover:bg-neon-accent/90 transition-colors duration-200 font-medium text-sm">
